    ...
    },
    {
      ...
      onClick: () => {
        const textMessage = encodeURIComponent(
          "Hello Yasin!, [your message here]"
        );
        window.open(
          `https://wa.me/+917077481699?text=${textMessage}`,
          "_blank",
          WIN_FEATURES
        );
      },
  ...
  shortcutApps: [
    {
      ...
      onClick: () => {
        window.open(
          // "https://www.google.com/search?q=skyasinbux+github",
          "https://www.google.com/",
          "_blank",
          WIN_FEATURES
        );
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.linkedin.com/in/sk-yasin-bux-0193ba201/",
          "_blank",
          WIN_FEATURES
        );
      },
    ...
    },
    {
      ...
      width: 35,
      height: 35,
      onClick: () => (window.location.href = "mailto:yasinbux4@gmail.com"),
    },
    // {
    //   name: "Search",
    ...
    {
      name: "Portfolio",
      icon: icons.apps.PortfolioPic,
      width: 35,
      height: 35,
      onClick: () => {
        window.open(
          "https://skyasinbux.vercel.app/",
          "_blank",
          WIN_FEATURES
        );
      },
