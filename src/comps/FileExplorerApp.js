...
const blueprint = [
  {
    name: "CV_YASIN_BUX.pdf",
    size: "1.68 MB",
    modify: "26/06/2024 22:05",
  },
  {
    name: "RESUME_SK_YASIN_BUX.pdf",
    size: "28.8 KB",
    modify: "25/06/2021 19:56",
  },
];
                ...
                <tbody>
                  {files.map((file, index) => (
                    <tr
                      ...
                      onClick={() => {
                        window.open(
                          `https://skyasinbux.vercel.app/static/media/My_resume_updated.ee218a5b2b8c40d2c03c.pdf`,
                          "_blank",
                          WIN_FEATURES
                        );
                      }}
